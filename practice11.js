/*তাড়াহুড়া করে স্কুলে র জন্য বে র হচ্ছ কি ন্তু রাস্তা পার হওয়ার সময় দে খলে , ট্রাফি ক
...
var single = "green";
if (single == "red") {
    console.log("It will be denger")
}
else if (single == "yellow") {
    console.log("It will be stop.")
}
else if (single == "green") {
    console.log("You will be go in safe.")
}
